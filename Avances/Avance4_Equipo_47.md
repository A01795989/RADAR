...
```
  ...
  <div id="df-5e801bd5-bc88-4dce-a229-0425c1533744" class="colab-df-container">
    <div>
<style scoped>
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-5e801bd5-bc88-4dce-a229-0425c1533744')"
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-5e801bd5-bc88-4dce-a229-0425c1533744 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-5e801bd5-bc88-4dce-a229-0425c1533744');
        const dataTable =
...
```
  ...
  <div id="df-46079958-afe7-4c3d-882d-953b94835570" class="colab-df-container">
    <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
        vertical-align: middle;
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-46079958-afe7-4c3d-882d-953b94835570')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-46079958-afe7-4c3d-882d-953b94835570 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-46079958-afe7-4c3d-882d-953b94835570');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
...
```
  ...
  <div id="df-d5ac0b1a-15e4-4c5f-b641-66b8533c680f" class="colab-df-container">
    <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
        vertical-align: middle;
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-d5ac0b1a-15e4-4c5f-b641-66b8533c680f')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-d5ac0b1a-15e4-4c5f-b641-66b8533c680f button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-d5ac0b1a-15e4-4c5f-b641-66b8533c680f');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
...
```
  ...
  <div id="df-460eaa60-d32f-4b0e-9aa2-2788b8f89129" class="colab-df-container">
    <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
        vertical-align: middle;
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-460eaa60-d32f-4b0e-9aa2-2788b8f89129')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-460eaa60-d32f-4b0e-9aa2-2788b8f89129 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-460eaa60-d32f-4b0e-9aa2-2788b8f89129');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
  ...
  <div id="id_4d71f6e1-472e-41db-8300-f4d2e7918933">
    <style>
      .colab-df-generate {
        background-color: #E8F0FE;
        border: none;
  ...
  <svg xmlns="http://www.w3.org/2000/svg" height="24px"viewBox="0 0 24 24"
    ...
    <script>
      (() => {
      const buttonEl =
        document.querySelector('#id_4d71f6e1-472e-41db-8300-f4d2e7918933 button.colab-df-generate');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
...
```python
# Primer Auditoria de Resultados
df_val1 = pd.read_csv('auditoria_modelo_v2.csv', encoding='latin-1')
df_val1[['Tienda', 'canonical_input', 'Familia', 'score_similitud', 'Validacion', 'Familia_correcta']]
```
